...
- **food_log.md** — running food log, updated immediately after each meal is reported

---

## 1. Kitchen & Training Context

### Kitchen Strengths

- Instinctively uses formulas over recipes — the pasta bake (frozen meatballs + jarred sauce + dry pasta + oven) is the model
- Loves and actively uses a dutch oven — barbacoa, carnitas, Italian beef, salsa chicken
- Works from home — hands-off and low-and-slow cooking are genuinely accessible most days
- Comfortable with long oven/dutch oven times; doesn't need to babysit food
- Good instinct for immediate ingredient prep: pulls rotisserie chicken off the carcass as soon as she gets home — this is the model for all landing tasks when groceries arrive
...
- Overthinking what to cook → decision fatigue → frozen pizza or takeout
- Versatile proteins go in the cart without a committed purpose → open-ended at cook time → paralysis at 9:30pm when executive function is gone
...
### Core Cooking Formulas

Each formula is a template — the flavor profile rotates, the process doesn't. Low-decision weeknight cooking.

| Formula | Structure | Examples |
|---|---|---|
| Dutch Oven Dump | Fat + aromatics + protein + liquid + time | Barbacoa, carnitas, Italian beef, salsa chicken |
| Pasta Bake | Starchy base + protein + sauce + oven | Frozen meatballs + jarred sauce + dry pasta |
| Sheet Pan | Protein + veg + olive oil + seasoning → 400°F → 25 min | Chicken thighs + frozen veg + seasoning |
...
The problem isn't planning — it's that proteins go in the cart with no committed purpose. Fix: **two-second mental commit at the meat case**. Not a full meal plan — just a default direction before it hits the cart.
...
Protein chosen → supporting ingredients auto-follow. Shopping decisions shrink to: which proteins this trip, and do I have what goes with them?

| If you buy... | Cook it as... | You also need... |
|---|---|---|
| Chuck roast | Italian Beef | Pepperoncini, beef broth, Italian seasoning, hoagie rolls, provolone |
...
Goal: always have at least one item in each category so assembly is possible without a plan.
...
Highest-ROI tasks to do when already in the kitchen — not as a separate event:

- Pull rotisserie chicken off the carcass immediately — non-negotiable
...
- 1–2 dutch oven / roast proteins (chuck roast or pork shoulder — versatile, freeze well, stretch far)
- 1 quick weeknight protein (chicken breasts → Foreman → fridge; ground meat or sausage with default assigned)
- Pantry/freezer proteins always stocked (canned fish, eggs, frozen shrimp, pre-cooked meatballs)

*Don't overbuy raw proteins unless freezing intentionally on arrival. Too many open-ended proteins = too many open questions at 9:30pm.*

### Blood Sugar / A1C Framework

Approach: **add before subtract** — incremental improvement, not overhaul.

Three highest-leverage shifts:
1. **Beans everywhere, always** — white beans, black beans, chickpeas. Fiber + protein = one of the best blood sugar stabilizers available.
2. **Never eat carbs naked** — quinoa with protein and fat, sweet potato with tahini or yogurt alongside, gnocchi with sausage in it. The pairing moderates the glucose spike.
3. **Quinoa as default grain** — higher protein, more fiber, lower GI than white rice. Make it the default when it doesn't matter.
...
- **Lemon tahini** — 3 tbsp tahini + juice of half a lemon + garlic + pinch of salt + water to thin. Keeps all week.
- **Smoky yogurt** — Greek yogurt + lemon + smoked paprika or smoky hot sauce + salt + garlic powder
- **Fried rice sauce** — ~½ cup soy sauce + chili garlic sauce + oyster sauce + red pepper flakes + splash of rice vinegar after tasting. Confirmed ratio.
- **Curry yogurt** — Greek yogurt + spoonful of red curry paste + squeeze of lemon *(flagged for future experiment)*
...
**Fried rice** *(confirmed May 2026)*
Canola oil, onion + garlic, frozen veg, brown rice, sesame oil, fold in 4 scrambled eggs, fried rice sauce. Wok preferred. One pan, 10 min. Nick-approved.

**Baby back ribs — Weber kettle** *(confirmed Memorial Day 2026)*
Two-zone indirect, 225–250°F, apple/cherry wood, ~5 hours total (3 unwrapped → 1–1.5 foil → 30 min sauced). Toothpick test between bones; rack bends dramatically when done.

**White bean and sausage skillet**
Slice or crumble sausage, brown, remove. Cook garlic in fat 30 sec. Add 2 cans white beans (drained) + splash of white wine or chicken broth (~½ cup). Simmer 8–10 min until creamy. Add sausage back, handful of spinach, wilt. Salt, pepper, squeeze of lemon. Crusty bread. The beans get silky from the pan drippings — that's the whole trick.

**Sheet pan chicken + sweet potato** *(confirmed May 2026)*
Cube sweet potato ¾ inch, 425°F 10–12 min first. Add chicken breasts same seasoning, 20–22 more min. Lime at end. Lemon tahini alongside. Nick-friendly, reheats well.

**Glazed salmon**
Brush with chili garlic sauce + soy + honey + rice vinegar. 400°F, 12–14 min. Sheet pan. Done.
...
Organized by protein — matches how you shop and plan.

### Ground Beef

- **Korean beef bowl** — brown, add soy/sesame oil/garlic/ginger/gochujang/honey, over rice, fried egg on top. 15 min.
- **Beef and bean skillet** — brown beef, dump in canned beans + canned tomatoes or salsa + cumin/chili powder. Tortillas, over rice, or with chips. Crack an egg in at the end.
- **Dirty rice** — brown beef with onion, black pepper and cajun seasoning, stir into leftover rice in the same pan.
- **Smash burgers** — fast, minimal dishes

### Ground Pork / Turkey

- **Larb bowl** — cook loose, fish sauce/lime/chili flake/pinch of sugar, over rice with cucumber. Fast and different.
- **Ginger pork rice bowl** — ground pork + garlic + ginger + soy + mirin, over rice. 15 min.
- **Pork and kimchi skillet** — brown pork, add kimchi + sesame oil, over rice. Zero thinking if kimchi is around.

### Italian Sausage

- **Stovetop gnocchi** — see Quick Reference for confirmed technique
- **White bean and sausage skillet** — see Quick Reference
- **Skillet pasta** — Italian sausage + jarred tomatoes or sauce + pasta + parmesan
- **Sheet pan sausage and peppers** — sausage + peppers + onions + olive oil + seasoning. 400°F, 30–35 min. Over polenta or with bread.
- **White bean and sausage bake** — Italian sausage + 2 cans white beans + fire roasted tomatoes + broth + dried herbs + olive oil. Dutch oven or baking dish, 350°F, 45 min.
...
- **Thai coconut soup** — chicken broth (Better than Bullion) + coconut milk + curry paste + rice noodles + spinach + lime. 25 min.
- **Sheet pan chicken + sweet potato** — see Quick Reference
- **Braised tomato & olive chicken** — thighs + canned tomatoes + olives + garlic + dried herbs, dutch oven

### Salmon / Fish

- **Glazed salmon** — see Quick Reference
- **Baked salmon with sheet pan vegetables** — same idea, different veg

### No-Cook / Assembly

- Grain bowl: pre-cooked grain + protein + sauce + greens
- Tacos / burritos: leftover dutch oven meat + tortillas + whatever's around
- Snack plate dinner: deli meat, cheese, olives, crackers, fruit, hummus
...
- Barbacoa, carnitas, Italian beef, salsa chicken (see protein defaults above)
- Braised short ribs or chuck roast
- Italian pulled pork
- Chili — ground beef or turkey + chili beans + fire roasted tomatoes + spices. 45 min simmer, 4+ meals.

### Eggs

- Shakshuka — fire roasted tomatoes + eggs cracked in + spices. 20 min, one pan.
- Frittata, loaded scramble
- Egg cracked into any skillet meal at the end
...
- **Chicken, dried cranberries, blue cheese or feta, walnuts or slivered almonds, vinaigrette**
- **Chipotle bag salad + black beans + Foreman chicken** *(confirmed May 2026)* — high protein, fiber from beans, Nick-friendly. Half dressing packet when splitting.

### Summer Additions (Marty)
...
- BLT salad — romaine + bacon + tomato + avocado + croutons + blue cheese or caesar
- Mango + chicken + avocado + red onion + cilantro + lime
...
- Traditional Greek
- Antipasto — salami/pepperoni + provolone + pepperoncini + roasted red peppers + artichoke hearts + olives + Italian dressing

*Salad strategy for two: shared base, diverge on toppings. Pre-cooked Foreman chicken goes in both bowls.*
...
*Private working document. Retrieved from GitHub (corporatehippy/Claude) via MCP at the start of each 1A session.*

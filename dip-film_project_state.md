...
**Core Themes:**
- Mental health recovery through ritual
- Unexpected friendship as lifeline
- Grief sitting next to joy
- Physical commitment as emotional transformation
...
**Key Dates:**
- Earlybird Deadline: March 31, 2026 (passed)
...
- Online screener mandatory — Vimeo preferred, download must be enabled. Include link + password.
- Press kit optional but recommended (electronic only)
- They accept works-in-progress — no need to wait for full polish before submitting
- Music/audio rights: CLEAN — film uses only original ambient audio, no licensed music
- Festival accepts films completed within two calendar years of festival date

**Why This Festival:**
- Local/regional focus (UP Michigan, Lake Superior subject matter)
- Community connection to story
- First-time filmmaker friendly — explicit award category for it
- Accepts works-in-progress
- Festival also tours satellite roadshows — accepted films from Oct 2026 considered for 2027 roadshows
...
- GoPro footage (Marty's addition, landscape, shore-based + some in-water)
- Daily selfies (stills + Live Photos converted to video) - full archive Sept–present
- Photos app album scroll screen capture
- Walking to Jeep in dark (atmospheric b-roll)
- Ice-breaking with hammers/rakes
- **KEY SHOT: March 3 GoPro on floating ice sheet** — water-level shot, sun on faces, shoulder-deep, surrounded by ice, laughing. Ending anchor.

**Technical Setup:**
- Editing in DaVinci Resolve
- Using timeline versions for version control
...
## AUDIO TRACK LAYOUT (for Fairlight reference)

- **A1:** Primary ambient — GoPro base layer and iPhone section base (waves, wind, conversation)
- **A2:** Second iPhone clip — plays simultaneously with A1 in multi-clip portrait sections
- **A3:** Third iPhone clip — plays simultaneously with A1+A2 in multi-clip portrait sections
...
## SCRIPT / NARRATIVE STRUCTURE (v5 - current)

### ACT 1 - INTRO (Sept)
- Cold open: extreme winter → "this is the thing that brought me back to life"
- Origin: met Dawn at bike clinic 2021, friends but not close
- September: Dawn's boys, school drop-offs, selfies with wet faces, big smiles
- "That looks like joy."

### ACT 2 - HOW AND WHY IT STARTED
- Injury section: plantar fasciitis, three years, couldn't hike/run, "that's what kept me sane"
- Recovery: out of shape, overweight, miserable, depressed
- The invite: reacted to story, "join us tomorrow", kept coming
- Twenty minutes ritual established
- Dawn's grief: Tara's loss, lake as connection point
...
### ACT 4 - WRAP UP
- Mornings: talk through life / breathe and smile / postcard
- Hammers and rakes: "that line keeps moving"
- Internal shift: lighter, braver, grateful
